...
CREATE TABLE STORE(store_id INTEGER NOT NULL,
address TEXT,
 CONSTRAINT P4 PRIMARY KEY(store_id) 
 );


CREATE TABLE CHECKOUT(checkout_id INTEGER NOT NULL,
cust_id INTEGER,
date DATE,
...
SSN BIGINT NOT NULL,
 ...
 CREATE TABLE DEPENDENT(emp_id INTEGER NOT NULL,
 date_joined DATE,
 email TEXT,
 address TEXT,
 date_birth DATE,
 name TEXT,
 CONSTRAINT F8 FOREIGN KEY(emp_id) REFERENCES EMPLOYEE(emp_id)
 );
...
CREATE TABLE FINANCE(f_id INTEGER NOT NULL,expense REAL,income REAL,tax REAL,profit REAL,CONSTRAINT P9 PRIMARY KEY(f_id));